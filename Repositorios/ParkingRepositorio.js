...
export class ParkingRepositorio {
    ...
    facturacion(fecha1, fecha2, listaTicketsPagados) {
        ...
        facturados.forEach(Ticket => {
            console.log(`El vehiculo con matricula ${Ticket.matricula} estacionado en la plaza ${Ticket.plaza}`);
            console.log(`Llego el dia ${Ticket.fechaLlegada.format('llll')}`);
            console.log(`Salió el dia ${Ticket.fechaSalida.format('llll')}`);
            console.log(`Pago un total de ${Ticket.precio} €`);
        });
